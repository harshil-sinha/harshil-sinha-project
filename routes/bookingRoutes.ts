...
import { createBooking, cancelTicket } from "../controllers/bookingController";
...
router.post("/create", async (req: Request<{}, {}, CreateBookingRequestBody>, res: Response) => {
  try {
...
router.post("/cancel", async (req: Request<{}, {}, CancelTicketRequestBody>, res: Response) => {
  try {
